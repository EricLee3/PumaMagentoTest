...
public class TestAPIServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest resqust, HttpServletResponse respose) {
		...
		//logger.debug("testApi respose:"+callAPI("http://localhost:8080/recvApi", params));
	...
	public JSONObject createOutboundTest() {
		...
		recvRow1.put("acperNm", "Elvis Error");
		...
		recvRow1.put("acperBasic", "��� ���ν� ó�α� ������ ���븮 341-10");
		recvRow1.put("acperDetail", "���ϱ����  203ȣ");
		recvRow1.put("ordNm", "Elvis Error");
		...
		recvRow1.put("ordBasic", "��� ���ν� ó�α� ������ ���븮 341-10");
		recvRow1.put("ordDetail", "���ϱ����  203ȣ");
		...
		recvRow2.put("acperNm", "Elvis Error");
		...
		recvRow2.put("acperBasic", "��� ���ν� ó�α� ������ ���븮 341-10");
		recvRow2.put("acperDetail", "���ϱ����   203ȣ");
		recvRow2.put("ordNm", "Elvis Error");
		...
		recvRow2.put("ordBasic", "��� ���ν� ó�α� ������ ���븮 341-10");
		recvRow2.put("ordDetail", "���ϱ����  203ȣ");
		...
		recvRow3.put("acperNm", "Elvis Error");
		...
		recvRow3.put("acperBasic", "��� ���ν� ó�α� ������ ���븮 341-10");
		recvRow3.put("acperDetail", "���ϱ����  203ȣ");
		recvRow3.put("ordNm", "Elvis Error");
		...
		recvRow3.put("ordBasic", "��� ���ν� ó�α� ������ ���븮 341-10");
		recvRow3.put("ordDetail", "���ϱ���� 203ȣ");
